...
/** "#5eb131" or "#abc" to { r, g, b }, or null when it is not a hex colour. */
 ...
 *  Threshold 128 is the classic split, and it keeps dark text on a mid green,
 *  matching the built-in --primary-foreground. */
